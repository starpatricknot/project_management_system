			...
			<div class="row">
				<div class="col-md-5">
					...
					<!-- <div class="form-group">
						...
						<input type="time" class="form-control form-control-sm" name="end_time" value="<?php #echo isset($end_time) ? date("H:i",strtotime("2020-01-01 ".$end_time)) : '' 
																										?>" required>
					</div> -->
				</div>
				<div class="col-md-7">
...
<script>
	$(document).ready(function() {
		...
		$('#manage-progress').submit(function(e) {
			...
			$('#manage-progress [required]').each(function() {
				if ($(this).val() === '') {
					valid = false;
